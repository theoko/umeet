...
function (_React$Component) {
  ...
  function Navigation(props) {
    ...
    _this.state = {
      links: [] // First entry should be the home page link

    };

    for (var i = 0; i < _this.props.pages.length; i++) {
      _this.addNavbarEntry(_this.props.pages[i].linkText, _this.props.pages[i].activeLink, _this.props.pages[i].linkTo);
    }
...
//# sourceMappingURL=index.js.85c0ef47725c4f423c10.hot-update.js.map