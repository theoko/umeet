...
function (_React$Component) {
  ...
  _createClass(Navigation, [{
    ...
    value: function componentDidMount() {
      // First entry should be the home page link
      for (var i = 0; i < this.props.pages.length; i++) {
        addNavbarEntry(this.props.pages[i].linkText, this.props.pages[i].activeLink, this.props.pages[i].linkTo);
      }
    }
  }, {
    key: "addNavbarEntry",
...
//# sourceMappingURL=index.js.b580f0caf5d049ac10cc.hot-update.js.map